...
<!-- [![My Skills](https://skillicons.dev/icons?i=py,java,go,js,ts,html,css,htmx,react,regex,github,git,mysql,sqlite,docker,nodejs,vscode,pr,ps,ai)](https://skillicons.dev) -->
...
<!-- [![Learning](https://skillicons.dev/icons?i=c,cpp,express,mongodb,tailwind,dotnet,aws,azure)](https://skillicons.dev) -->
